...
from BhaukaalBaba import Riz, Riz2, Riz3, Riz4, Riz5 , Riz6, Riz7, Riz8, Riz9, Riz10, Riz11, Riz12, Riz13, Riz14, Riz15, Riz16, Riz17, Riz18, Riz19, Riz20, Riz21, Riz22, Riz23, Riz24, Riz25, Riz26, Riz27, Riz28, Riz29, Riz30, Riz31, Riz32, Riz33, Riz34, Riz35, Riz36, Riz37, Riz38, Riz39, Riz40, DEV, HEROKU_APP_NAME, HEROKU_API_KEY
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/ERR0rMK/BhaukaalBaba"
BOT_IS_UP_TO_DATE = "**The Bhaukaal Baba Spam** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your Bhaukaal Baba Spam ..."
)
...
async def restart(e):
    if e.sender_id in DEV:
        text = "__ updating Your BhaukaalBaba Userbots __\n **Type** .ping **After 5min To check I'm On !!**"
...
async def deploy_start(Riz, message, refspec, remote):
    ...
    await message.edit(
        "__Updated your BhaukaalBaba Spam successfully sur__ !!!\n\n © @ERR0rMK"
    )
